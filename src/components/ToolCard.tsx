...
const iconMap: Record<string, string> = {
  ...
  "yuque": "ph:bird-duotone",
  "timecat": "noto:cat",
  "capstolowercase": "ph:text-aa-duotone",
  "imagestool": "ph:image-square-duotone",
  "iconfont": "logos:alibaba",
  "remixicon": "simple-icons:remix",
  "qingicon": "ph:atom-duotone",
  "howxm": "ph:chart-bar-duotone",
  "asorn": "ph:user-circle-duotone",
  "biliui": "simple-icons:bilibili",
  "svgcool": "logos:svg",
  "isparta": "ph:film-strip-duotone",
  "gifski": "ph:gif-duotone",
  "licecap": "ph:record-duotone",
  "eltima": "ph:images-duotone",
  "filterforge": "ph:magic-wand-duotone",
  "picwish": "fluent-emoji-flat:magic-wand",
  "inboxflows": "ph:envelope-open-duotone",
  "shenyandayi": "noto:books",
  "bitbug": "noto:bug",
  "realfavicongenerator": "noto:glowing-star",
  "svgfactory": "logos:svg",
  "polarr": "ph:aperture-duotone",
  "editphoto": "ph:pencil-simple-duotone",
  "screenstudio": "ph:video-camera-duotone",
  "cap": "noto:billed-cap",
  "recordly": "ph:record-duotone",
  "tableconvert": "ph:table-duotone",
  "youmemark": "ph:bookmark-duotone",
  "linktree": "simple-icons:linktree",
